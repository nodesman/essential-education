...
*   A city where you cannot walk is a city where you cannot think. 
*   We want **Level, Continuous, and Shade-covered** sidewalks as a primary municipal good. 
*   We want the removal of the "Flyover Culture" that divides neighborhoods and increases noise. 
...
*   We want the **Metro, the Bus, and the Last-Mile cycle** to be the veins of the city. 
*   We want a system where the **CEO and the Clerk** stand together on the train. 
*   We want the "Public Transport" to be so good that only the poor drive cars. 
...
*   We want **Green Lungs** in every neighborhood. 
*   We want **Libraries** that are centers of innovation, not just dusty archives. 
*   We want **Public Squares** where we can debate and celebrate without a "Ticket." 
